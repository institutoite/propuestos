                        ...
                        <form action="{{ route('restas.store') }}" method="POST" novalidate>
                            ...
                            <div class="grid-2">
                                <div>
                                    ...
                                    <div class="hint" id="hint-digitos">Mínimo según dificultad seleccionada.</div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="hint">Recomendado: 10–30 para una hoja.</div>
                                </div>
                            </div>
                            ...
                            <div class="mt-3">
                                ...
                                <div class="input-wrap">
                                    ...
                                    >
                                        ...
                                        <option value="SUPERDIFICIL">SUPERDIFICIL (1,2,3,4,5,6) - 2 acarreos (min. 3 dígitos)</option>
                                        <option value="ULTRADIFICIL">ULTRADIFICIL (1,2,3,4,5,7) - 3 acarreos (min. 4 dígitos)</option>
                                        <option value="TIPOEXAMEN">TIPOEXAMEN (0-9) - acarreos en todas menos la primera (min. 5 dígitos)</option>
                                    </select>
                                </div>
