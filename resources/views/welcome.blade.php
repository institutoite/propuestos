    ...
    <div class="container">
        <div class="text-center mb-4">
            ...
            <p class="section-sub mt-2">
                ITE es una iniciativa enfocada en educación y tecnología: creamos recursos, sistemas y herramientas
                para que el aprendizaje sea más claro, práctico y medible.
            </p>
        </div>
            ...
            <div class="col-lg-7">
                ...
                <form class="cardx">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="phone" type="tel" class="form-control" required name="phone_number" placeholder="Ej: +591 7XXXXXXX">
                        <div class="form-text text-muted">Usa tu número real para que podamos responderte rápido.</div>
                    </div>
